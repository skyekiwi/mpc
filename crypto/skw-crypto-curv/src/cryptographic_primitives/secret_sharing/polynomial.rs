...
impl<E: Curve> Polynomial<E> {
    ...
    ///
    /// ```rust
    /// # use skw_crypto_curv::cryptographic_primitives::secret_sharing::Polynomial;
    ...
    /// use skw_crypto_curv::cryptographic_primitives::secret_sharing::PolynomialDegree;
    ///
    ...
    /// ```rust
    /// # use skw_crypto_curv::cryptographic_primitives::secret_sharing::Polynomial;
    /// use skw_crypto_curv::elliptic::curves::{Secp256k1, Scalar};
    ///
    ...
    ///
    /// ```rust
    /// # use skw_crypto_curv::cryptographic_primitives::secret_sharing::{Polynomial, PolynomialDegree};
    /// use skw_crypto_curv::elliptic::curves::{Secp256k1, Scalar};
    ///
    ...
    /// ```rust
    /// use skw_crypto_curv::cryptographic_primitives::secret_sharing::Polynomial;
    /// # use skw_crypto_curv::elliptic::curves::*;
    ///
    /// # let t = 3;
