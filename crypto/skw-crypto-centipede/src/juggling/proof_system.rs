...
use skw_crypto_curv::cryptographic_primitives::proofs::{
    sigma_correct_homomorphic_elgamal_encryption_of_dlog::{HomoELGamalDlogProof,HomoElGamalDlogWitness,HomoElGamalDlogStatement},
    sigma_correct_homomorphic_elgamal_enc::{HomoELGamalProof,HomoElGamalWitness,HomoElGamalStatement},
};
...
use skw_crypto_bulletproofs::proofs::range_proof::{RangeProof, generate_random_point};

use crate::juggling::segmentation::Msegmentation;
use crate::grad_release::{SegmentProof, FirstMessage};
use crate::Errors::{self, ErrorProving, ErrorSegmentProof, ErrorFirstMessage};
...
mod tests {
    use skw_crypto_curv::elliptic::curves::{secp256_k1::Secp256k1, Point, Scalar};
    use crate::juggling::proof_system::*;
    use crate::juggling::segmentation::Msegmentation;
    use crate::wallet::SecretShare;
