...
use skw_mpc_node::{
    MpcSwarmBahavior, MpcSwarmBahaviorEvent, MpcP2pRequest, MpcP2pResponse, 
    MpcSwarmCommand,
};

use skw_mpc_node::error::{ MpcNodeError, SwarmError, SwarmP2pError };
        ...
        match event {
            ...
            SwarmEvent::Behaviour(MpcSwarmBahaviorEvent::RequestResponse(
                ...
                request_response::Message::Request {
                    ...
                    match request {
                        MpcP2pRequest::StartJob {  job_header,  auth_header, ..} => {
