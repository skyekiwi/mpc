...
use libp2p::{
    ...
    PeerId, Swarm, InboundUpgradeExt, OutboundUpgradeExt, 
...
pub fn new_full_swarm_node(
    ...
    let transport = {
        ...
        libp2p::Transport::upgrade(websocket::WsConfig::new(tcp::async_io::Transport::new(tcp::Config::default().nodelay(true))), libp2p::core::upgrade::Version::V1)
            .authenticate(
